<?php
/**
 * Title: Aggregated Wildfire (production copy)
 * Slug: bcgov-wordpress-block-theme-child-theme-emergency-info/aggregated-wildfire-production-copy
 * Categories: Events
 *
...
<!-- wp:block {"ref":3717,"lock":{"move":false,"remove":false,"edit":false}} /-->
            ...
            <figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/person-arrow.png' ); ?>" alt="" class="wp-image-61502" style="width:75px" title=""/></figure>
            <!-- /wp:image -->                                   
            ...
            <figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/noun-route-sign-4928866-12.png' ); ?>" alt="" class="wp-image-3365" title="" /></figure>
            <!-- /wp:image --></div>
            <!-- /wp:group -->
            <!-- /wp:areoi/column -->
            ...
            <figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/image-21.png' ); ?>" alt="" class="wp-image-61507" style="width:75px" title="" /></figure>
            <!-- /wp:image -->
