...
<div
    ...
    <div
        ...
        <h2
            ...
            >Active cold warnings in B.C.</h2
        >
        <!-- /wp:heading -->
            ...
            <div
                ...
                <div
                    ...
                    <h2
                        ...
                        ><strong>Cold Warnings</strong></h2
                    >
                    <!-- /wp:heading -->
...
<div
    ...
    <div
        ...
        <h2
            class="wp-block-heading"
            style="margin-bottom: var(--wp--preset--spacing--20); font-size: 1.88rem"
            >Emergency Warming Centres and Public Warming Spaces</h2
        >
        <!-- /wp:heading -->
        ...
        <div
            ...
            <div
                ...
                <h3 class="wp-block-heading has-small-font-size"
                    ><strong>If you are in the area under an&nbsp;[<strong>Extreme Cold or Arctic Outflow] Warning</strong>:</strong></h3
                >
                <!-- /wp:heading -->
            </div>
            <!-- /wp:group -->
            ...
            <div
                ...
                <div
                    ...
                    ><!-- wp:paragraph -->
                    <p
                        >To locate confirmed power outages in your region, go to BC Hydro’s
                        <a
                            href="https://www.bchydro.com/safety-outages/power-outages/outage_map.html"
                            target="_blank"
...
<div
    ...
    <div
        ...
        <h2
            class="wp-block-heading"
            style="margin-bottom: var(--wp--preset--spacing--20); font-size: 1.88rem"
            >Extreme cold safety and preparedness</h2
        >
        <!-- /wp:heading -->
                ...
                <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            style="border-top-left-radius: 10px; border-bottom-left-radius: 10px; border-top-color: var(--wp--preset--color--hazard-extreme-cold-secondary); border-top-width: 10px; border-right-color: var(--wp--preset--color--support-gray-02); border-right-width: 1px; border-bottom-color: var(--wp--preset--color--support-gray-02); border-bottom-width: 1px; border-left-color: var(--wp--preset--color--support-gray-02); border-left-width: 1px; padding-top: var(--wp--preset--spacing--20); padding-right: 0; padding-bottom: var(--wp--preset--spacing--20); padding-left: var(--wp--preset--spacing--20)"
                        ...
                        <div
                            class="wp-block-group h-100 has-white-background-color has-background"
                            style="border-top-right-radius: 10px; border-bottom-right-radius: 10px; border-top-color: var(--wp--preset--color--hazard-extreme-cold-secondary); border-top-width: 10px; border-right-color: var(--wp--preset--color--support-gray-02); border-right-width: 1px; border-bottom-color: var(--wp--preset--color--support-gray-02); border-bottom-width: 1px; border-left-color: var(--wp--preset--color--support-gray-02); border-left-width: 1px; padding-top: var(--wp--preset--spacing--20); padding-right: var(--wp--preset--spacing--20); padding-bottom: var(--wp--preset--spacing--20); padding-left: 0"
