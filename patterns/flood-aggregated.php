...
<div
    ...
    <div
        ...
        <p>ADD TO EXCERPT: Flooding is occurring in parts of B.C. For the most up to date information, visit your local authority or First Nation website.</p>
        <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->
</div>
...
<div
    ...
    ><!-- wp:group {"style":{"border":{"bottom":{"color":"var:preset|color|transparent"}},"spacing":{"margin":{"bottom":"var:preset|spacing|20"}}},"layout":{"type":"default"}} -->
    <div
        class="wp-block-group"
        style="border-bottom-color: var(--wp--preset--color--transparent); margin-bottom: var(--wp--preset--spacing--20)"
        ><!-- wp:heading {"style":{"typography":{"fontSize":"1.88rem"}}} -->
        <h2
            class="wp-block-heading"
            style="font-size: 1.88rem"
            ><strong>Local government evacuation information</strong></h2
        >
        <!-- /wp:heading -->
    ...
    <div
        ...
        ><!-- wp:group {"className":"hazard-border","style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}},"border":{"top":{"width":"10px"},"radius":{"topLeft":"10px","topRight":"10px"}}},"layout":{"type":"default"}} -->
        <div
            class="wp-block-group hazard-border"
            ...
            <div
                ...
                ><!-- wp:emergency-info/post-hazard-image /-->
        ...
        <div
            ...
            <div
                class="wp-block-group"
                style="padding-bottom: var(--wp--preset--spacing--20)"
                ><!-- wp:areoi/icon {"block_id":"4bc5af99-90a0-4d44-bca4-e940f72de678","style":"text-dark","icon":"bi-twitter"} -->
                <div class="wp-block-areoi-icon areoi-icon"
                    ><i
            ...
            <div
                class="wp-block-group"
                style="padding-bottom: var(--wp--preset--spacing--20)"
                ><!-- wp:areoi/icon {"block_id":"4bc5af99-90a0-4d44-bca4-e940f72de678","style":"text-dark","icon":"bi-facebook"} -->
                <div class="wp-block-areoi-icon areoi-icon"
                    ><i
...
<h2
    class="wp-block-heading"
    style="font-size: 1.88rem"
    ><strong>First Nations evacuation information</strong></h2
>
<!-- /wp:heading -->
...
<div
    ...
    <div
        ...
        <h2
            ...
            >Flood Watches and Warnings</h2
        >
        <!-- /wp:heading -->

        <!-- wp:paragraph -->
        <p>The River Forecast Centre has issued Flood [Watch/Warnings] for [the following areas/ multiple areas of BC]. Stay clear of the fast-flowing rivers and potentially unstable riverbanks.</p>
        <!-- /wp:paragraph -->
        ...
        <div
            ...
            <div
                ...
                ><!-- wp:image {"id":4207,"sizeSlug":"full","linkDestination":"none"} -->
                <figure class="wp-block-image size-full"
                    ><img
                        src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/flood-icon.png' ); ?>"
                        alt=""
                        class="wp-image-4207"
                        title=""
                /></figure>
            ...
            <div
                ...
                ><!-- wp:areoi/icon {"block_id":"39a66b63-5071-43b7-ab50-80429d5d6ab1","style":"text-dark","size":"36","icon":"bi-geo-alt","horizontal_align_xs":"text-center","lock":{"move":true,"remove":true}} -->
                ...
                <div
                    ...
                    <!-- wp:paragraph -->
                    <p>Paste content from RFC PDF here. </p>
                    <!-- /wp:paragraph -->
                </div>
                <!-- /wp:group -->
            </div>
            ...
            <div
                ...
                <div
                    ...
                    <h3 class="wp-block-heading has-small-font-size"
                        ><strong><a href="http://bcrfc.env.gov.bc.ca/warnings/index.htm">Visit the River Forecast Centre</a></strong></h3
                    >
                    <!-- /wp:heading -->

                    <!-- wp:paragraph {"lock":{"move":false,"remove":false}} -->
                    <p>Find updates on Flood Advisories from the River Forecast Centre.</p>
                    <!-- /wp:paragraph -->
                </div>
                <!-- /wp:group -->
            </div>
...
<div
    ...
    <div
        ...
        <h2
            class="wp-block-heading"
            style="margin-bottom: var(--wp--preset--spacing--20); font-size: 1.88rem"
            >Recommended actions for Evacuation Alerts
        </h2>
        <!-- /wp:heading -->
