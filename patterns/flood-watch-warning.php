        ...
        <div
            ...
            <div
                ...
                <div
                    ...
                    ><!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap"}} -->
                    <div class="wp-block-group"
                        ><!-- wp:areoi/icon {"block_id":"28ea8acf-dbd8-423a-9f66-49ae7ba5e88c","style":"text-dark","icon":"bi-geo-alt"} -->
                        <div class="wp-block-areoi-icon areoi-icon"
                            ><i
            ...
            <div class="wp-block-group"
                ...
                <p
                    ><a
                        ...
                        rel="noopener"
                        title=""
                        >Evacuation Flood Watch - [Area] (PDF)</a
                    ></p
                >
                <!-- /wp:paragraph -->
            </div>
