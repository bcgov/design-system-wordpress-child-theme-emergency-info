...
<!-- wp:group {"metadata":{"name":"Social media section"},"style":{"spacing":{"padding":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|30"}}},"backgroundColor":"banner-background-dark","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-banner-background-dark-background-color has-background" style="padding-top:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30)"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"layout":{"type":"flex","flexWrap":"nowrap","orientation":"vertical","justifyContent":"center"}} -->
    <div class="wp-block-group"><!-- wp:paragraph {"align":"center","style":{"elements":{"link":{"color":{"text":"var:preset|color|background-white"}}}},"textColor":"background-white"} -->
        ...
        <div class="wp-block-group"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
            <div class="wp-block-group"><!-- wp:social-links {"iconColor":"typography-color-secondary","iconColorValue":"var(\u002d\u002ddswp-typography-color-secondary)","iconBackgroundColor":"support-gray-00","iconBackgroundColorValue":"#FAFBFF","size":"has-small-icon-size"} -->
                <ul class="wp-block-social-links has-small-icon-size has-icon-color has-icon-background-color"><!-- wp:social-link {"url":"https://x.com/EmergencyInfoBC","service":"x"} /--></ul>
                <!-- /wp:social-links -->
            ...
            <div class="wp-block-group"><!-- wp:social-links {"iconColor":"typography-color-secondary","iconColorValue":"var(\u002d\u002ddswp-typography-color-secondary)","iconBackgroundColor":"support-gray-00","iconBackgroundColorValue":"#FAFBFF","size":"has-small-icon-size"} -->
                <ul class="wp-block-social-links has-small-icon-size has-icon-color has-icon-background-color"><!-- wp:social-link {"url":"https://www.facebook.com/EmergencyInfoBC","service":"facebook"} /--></ul>
                <!-- /wp:social-links -->
...
<div class="wp-block-group bcgov-footer-container has-support-gray-00-background-color has-background has-link-color" style="padding-top:2rem;padding-right:2rem;padding-bottom:2rem;padding-left:2rem;font-size:0.88rem"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"layout":{"type":"flex","flexWrap":"wrap","justifyContent":"space-between"}} -->
    <div class="wp-block-group"><!-- wp:group {"style":{"spacing":{"padding":{"top":"0","bottom":"0"},"blockGap":"var:preset|spacing|20"}},"layout":{"type":"constrained","justifyContent":"left"}} -->
        ...
        <div class="wp-block-group"><!-- wp:heading {"className":" text-uppercase","style":{"spacing":{"margin":{"bottom":"1rem","top":"0"}},"typography":{"textTransform":"uppercase","fontStyle":"normal","fontWeight":"700"}},"fontSize":"normal"} -->
