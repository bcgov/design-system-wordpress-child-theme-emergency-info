...
<figure class="wp-block-image size-full"><a href="https://test.vanity.blog.gov.bc.ca/app/uploads/sites/2/2023/05/okib-evac.png"><img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/okib-evac.png' ); ?>" alt="" class="wp-image-1832" title="" /></a></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
<!-- /wp:areoi/column -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"left":"var:preset|spacing|20"}}},"layout":{"type":"constrained","justifyContent":"left"}} -->
<div class="wp-block-group" style="padding-left:var(--wp--preset--spacing--20)"><!-- wp:heading {"level":3,"fontSize":"small"} -->
<h3 class="wp-block-heading has-small-font-size"><strong><a href="https://www2.gov.bc.ca/gov/content?id=9B4B3AE951654A8AA3319CF1F779D489" title="">General Emergency evacuee guidance for the public</a></strong></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"lock":{"move":false,"remove":false}} -->
<p>What to do when you receive an Evacuation Order or Evacuation Alert </p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"left":"var:preset|spacing|20"}}},"layout":{"type":"constrained","justifyContent":"left"}} -->
<div class="wp-block-group" style="padding-left:var(--wp--preset--spacing--20)"><!-- wp:heading {"level":3,"fontSize":"small"} -->
<h3 class="wp-block-heading has-small-font-size"><strong><a href="https://www2.gov.bc.ca/gov/content/safety/emergency-management/preparedbc/know-your-hazards" title="">PreparedBC</a></strong></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"lock":{"move":false,"remove":false}} -->
<p>Learn how to prepare for hazards in your community with resources from PreparedBC.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
<!-- /wp:areoi/column -->
