        ...
        <div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20)"><!-- wp:group {"layout":{"type":"default"}} -->
            <div class="wp-block-group"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|30"}},"layout":{"type":"default"}} -->
                <div class="wp-block-group">
                    ...
                    <!-- wp:paragraph -->
                    <p>EmergencyInfoBC provides emergency information for people in B.C. online at <a href="https://www.emergencyinfobc.ca/" title="">www.EmergencyInfoBC.ca</a> and on social media at <a href="https://x.com/emergencyinfobc" target="_blank" rel="noopener" title="">@EmergencyInfoBC on X (Twitter)</a> and on <a href="https://www.facebook.com/EmergencyInfoBC" target="_blank" rel="noopener" title="">Facebook</a>.</p>
                    <!-- /wp:paragraph -->
