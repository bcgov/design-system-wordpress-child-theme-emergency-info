...
/**
 * Title: About (Page)
 * Slug: design-system-wordpress-child-theme-emergency-info/page-about
 * Categories: page
 *
...
<div class="wp-block-group"><!-- wp:group {"className":"alignwide","style":{"spacing":{"padding":{"top":"var:preset|spacing|20","right":"var:preset|spacing|20","bottom":"var:preset|spacing|20","left":"var:preset|spacing|20"}}},"layout":{"type":"default"}} -->
    <div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20)"><!-- wp:group {"layout":{"type":"default"}} -->
        <div class="wp-block-group"><!-- wp:paragraph -->
            ...
            <h2 class="wp-block-heading is-style-alphagov-heading">Social media</h2>
            <!-- /wp:heading -->
            ...
            <!-- wp:heading {"className":"is-style-alphagov-heading"} -->
            <h2 class="wp-block-heading is-style-alphagov-heading">Media contacts</h2>
            <!-- /wp:heading -->

            <!-- wp:paragraph -->
            <p>For media enquiries related to the Ministry of Emergency Management and Climate Readiness, call <a href="tel:+12508806430" target="_blank" rel="noreferrer noopener">250-880-6430</a>. </p>
            <!-- /wp:paragraph -->
            ...
            <!-- wp:paragraph -->
            <p>For media enquires related to local States of Emergency and Evacuation Orders or Alerts, contact the <a href="https://www.civicinfo.bc.ca/directories" target="_blank" rel="noreferrer noopener">local authority</a>.</p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
    </div>
