<?php
/**
 * Title: Resources for Local Authorities and First Nations (Page)
 * Slug: design-system-wordpress-child-theme-emergency-info/page-resources-local-authorities-first-nations
 * Categories: page
 *
        ...
        <div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20)"><!-- wp:group {"layout":{"type":"default"}} -->
            <div class="wp-block-group"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|30"}},"layout":{"type":"default"}} -->
                <div class="wp-block-group"><!-- wp:heading {"className":"is-style-heading-callout"} -->
                    ...
                    <!-- wp:paragraph -->
                    <p>The Province of British Columbia has developed icons representing the most common hazards in B.C. They meet provincial accessibility requirements and are used by the Ministry of Emergency Managemetn and Climate Readiness, and other partners.</p>
                    <!-- /wp:paragraph -->

                    <!-- wp:paragraph -->
                    <p>Download the icon pack:&nbsp;<a href="https://www2.gov.bc.ca/assets/gov/public-safety-and-emergency-services/emergency-preparedness-response-recovery/embc/images/hazard_icons_for_communicating_during_emergencies.zip">Hazard and emergency icons for emergency communications (ZIP&nbsp;folder, 3MB)</a></p>
                    <!-- /wp:paragraph -->

                    <!-- wp:heading {"className":"is-style-heading-callout"} -->
                    <h2 class="wp-block-heading is-style-heading-callout">Communication resources by hazard type</h2>
                    <!-- /wp:heading -->

                    <!-- wp:heading {"level":3} -->
                    <h3 class="wp-block-heading">Wildfire</h3>
                    <!-- /wp:heading -->
                    ...
                    <ul class="wp-block-list"><!-- wp:list-item -->
                        ...
                        <!-- wp:list-item -->
                        <li><a href="https://www2.gov.bc.ca/assets/gov/public-safety-and-emergency-services/emergency-preparedness-response-recovery/embc/preparedbc/preparedbc-guides/wildfire_preparedness_guide.pdf">Wildfire Preparedness Guide (PDF, 4MB)</a></li>
                        <!-- /wp:list-item -->
                    </ul>
                    <!-- /wp:list -->
                    ...
                    <ul class="wp-block-list"><!-- wp:list-item -->
                        ...
                        <!-- wp:list-item -->
                        <li><a href="https://www.drivebc.ca/">DriveBC</a></li>
                        <!-- /wp:list-item -->
                    </ul>
                    <!-- /wp:list -->

                    <!-- wp:heading {"level":3} -->
                    <h3 class="wp-block-heading">Severe weather</h3>
                    <!-- /wp:heading -->
                    ...
                    <ul class="wp-block-list"><!-- wp:list-item -->
                        ...
                        <!-- wp:list-item -->
                        <li><a href="https://www2.gov.bc.ca/assets/gov/public-safety-and-emergency-services/emergency-preparedness-response-recovery/embc/preparedbc/preparedbc-guides/preparedbc_extreme_heat_guide.pdf">Extreme Heat Preparedness Guide (PDF, 9.2MB)</a></li>
                        <!-- /wp:list-item -->
                    ...
                    <ul class="wp-block-list"><!-- wp:list-item -->
                        ...
                        <!-- wp:list-item -->
                        <li><a href="http://www.bccdc.ca/health-professionals/professional-resources/heat-event-response-planning">BC Centre for Disease Control</a> (heat response planning)</li>
                        <!-- /wp:list-item -->
                    </ul>
                    <!-- /wp:list -->

                    <!-- wp:heading {"level":3} -->
                    <h3 class="wp-block-heading">Avalanches</h3>
                    <!-- /wp:heading -->
                    ...
                    <ul class="wp-block-list"><!-- wp:list-item -->
                        ...
                        <!-- wp:list-item -->
                        <li><a href="https://www2.gov.bc.ca/assets/gov/public-safety-and-emergency-services/emergency-preparedness-response-recovery/embc/preparedbc/preparedbc-guides/earthquake_and_tsunami_guide.pdf">Earthquake and Tsunami Preparedness Guide (PDF, 1.5MB)</a></li>
                        <!-- /wp:list-item -->
                    </ul>
                    <!-- /wp:list -->
                    ...
                    <!-- wp:heading {"level":3} -->
                    <h3 class="wp-block-heading">Tsunami</h3>
                    <!-- /wp:heading -->
                    ...
                    <ul class="wp-block-list"><!-- wp:list-item -->
                        ...
                        <!-- wp:list-item -->
                        <li>Greater Vancouver and Johnstone Strait</li>
                        <!-- /wp:list-item -->
                    </ul>
                    <!-- /wp:list -->

                    <!-- wp:paragraph -->
                    <p><strong>Tsunami alert levels:</strong></p>
                    <!-- /wp:paragraph -->
                    ...
                    <ul class="wp-block-list"><!-- wp:list-item -->
                        ...
                        <!-- wp:list-item -->
                        <li>Advisory: Strong currents possible; avoid beaches and marinas</li>
                        <!-- /wp:list-item -->

                        <!-- wp:list-item -->
                        <li>Watch: Potential threat; prepare to act</li>
                        <!-- /wp:list-item -->

                        <!-- wp:list-item -->
                        <li>Cancellation: Previous messages are cancelled when risk has passed.</li>
                        <!-- /wp:list-item -->
                    </ul>
                    <!-- /wp:list -->

                    <!-- wp:paragraph -->
                    <p><strong>Emergency hashtag:</strong></p>
                    <!-- /wp:paragraph -->
                    ...
                    <ul class="wp-block-list"><!-- wp:list-item -->
                        ...
                        <!-- wp:list-item -->
                        <li><a href="https://earthquake.usgs.gov/earthquakes/map/">U.S. Geological Survey (USGS)</a></li>
                        <!-- /wp:list-item -->
                    </ul>
                    <!-- /wp:list -->
                    ...
                    <ul class="wp-block-list"><!-- wp:list-item -->
                        ...
                        <!-- wp:list-item -->
                        <li><a href="https://www2.gov.bc.ca/assets/gov/public-safety-and-emergency-services/emergency-preparedness-response-recovery/embc/preparedbc/preparedbc-guides/preparedbc_landslide_info_for_homeowners_and_home_buyers.pdf">Landslide Information Guide (PDF, 2.05MB)</a></li>
                        <!-- /wp:list-item -->
                    </ul>
                    <!-- /wp:list -->
                    ...
                    <ul class="wp-block-list"><!-- wp:list-item -->
                        ...
                        <!-- wp:list-item -->
                        <li><a href="https://outages.fortisbc.com/Outages">FortisBC outage map</a></li>
                        <!-- /wp:list-item -->
                    </ul>
                    <!-- /wp:list -->

                    <!-- wp:heading {"level":3} -->
                    <h3 class="wp-block-heading">Pandemics and disease outbreaks</h3>
                    <!-- /wp:heading -->
                    ...
                    <ul class="wp-block-list"><!-- wp:list-item -->
                        ...
                        <!-- wp:list-item -->
                        <li><a href="https://www2.gov.bc.ca/assets/gov/public-safety-and-emergency-services/emergency-preparedness-response-recovery/embc/preparedbc/preparedbc-guides/preparedbc_pandemic_guide.pdf">Pandemic Preparedness Guide (PDF, 7.9MB)</a></li>
                        <!-- /wp:list-item -->
                    </ul>
                    <!-- /wp:list -->
                    ...
                    <ul class="wp-block-list"><!-- wp:list-item -->
                        ...
                        <!-- wp:list-item -->
                        <li><a href="https://www.bccdc.ca/">B.C. Centre for Disease Control</a></li>
                        <!-- /wp:list-item -->
                    </ul>
                    <!-- /wp:list -->

                    <!-- wp:heading {"level":3} -->
                    <h3 class="wp-block-heading">Hazardous material spills</h3>
                    <!-- /wp:heading -->
                    ...
                    <!-- wp:heading {"className":"is-style-heading-callout"} -->
                    <h2 class="wp-block-heading is-style-heading-callout">Community and highway hashtags</h2>
                    <!-- /wp:heading -->

                    <!-- wp:paragraph -->
                    <p>Hashtags are widely used to track conversations during emergencies. The <a href="https://www.tranbc.ca/tranbc-social-media-hash-tags-2/">BC Community Hashtag list</a> includes commonly used hashtags for communities and highways across the province.</p>
                    <!-- /wp:paragraph -->
                    ...
                    <!-- wp:heading {"className":"is-style-heading-callout"} -->
                    <h2 class="wp-block-heading is-style-heading-callout">Tourism and emergency information</h2>
                    <!-- /wp:heading -->

                    <!-- wp:paragraph -->
                    <p>Emergencies can impact travel, visitors, and tourism-related businesses. Sharing travel-focused emergency information can support those planning or currently on a trip in B.C.</p>
                    <!-- /wp:paragraph -->

                    <!-- wp:paragraph -->
                    <p>If you are visiting B.C., take the following steps to help you and your family stay safe:</p>
                    <!-- /wp:paragraph -->
                    ...
                    <!-- wp:paragraph -->
                    <p>For tourism operators, review <a href="https://www.destinationbc.ca/what-we-do/destination-management/emergency-preparedness/">Destination British Columbia’s Emergency Resources for BC’s Tourism Industry</a> for information on how to prepare for emergencies.</p>
                    <!-- /wp:paragraph -->
                </div>
                <!-- /wp:group -->
            </div>
