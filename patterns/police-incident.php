        ...
        >
            ...
            >
                ...
                >
                    ...
                    <!-- wp:paragraph {"className":"d-inline"} -->
                    <p class="d-inline">Be alert and follow any direction from police or officials in the area.&nbsp; </p>
                    <!-- /wp:paragraph -->
                </div>
                <!-- /wp:group -->
            </div>
            ...
            >
                ...
                >
                    ...
                    <!-- wp:paragraph {"className":"d-inline"} -->
                    <p class="d-inline">These lines must be kept open for urgent needs. Only call 9-1-1 when a life is at risk.<strong> </strong></p>
                    <!-- /wp:paragraph -->
                </div>
                <!-- /wp:group -->
            </div>
            ...
            >
                ...
                >
                    ...
                    <h3 class="wp-block-heading has-small-font-size"
                        ><a
                            title=""
                            href="https://www2.gov.bc.ca/gov/content/justice/criminal-justice/policing-in-bc/bc-police-services"
                            ><strong>Find your local police service in B.C.</strong></a
                        ></h3
                    >
                    <!-- /wp:heading -->
                </div>
            ...
            >
                ...
                >
                    ...
                    <h3 class="wp-block-heading has-small-font-size"
                        ...
                        ><a
                            title=""
                            href="https://www.healthlinkbc.ca/mental-health-and-substance-use/mental-health/mental-health-supports-and-resources"
                            ><strong>HealthLinkBC: mental health supports and resources</strong></a
                        ></h3
                    >
                    <!-- /wp:heading -->
                </div>
