...
<div
    ...
    ><!-- wp:areoi/row {"block_id":"54cdb828-f950-41f7-b4cd-710e2b5875b1","vertical_align_xs":"Default","row_cols_xs":"row-cols-1","row_cols_sm":"row-cols-sm-1","row_cols_md":"row-cols-md-2"} -->
        ...
        <div
            ...
            <div class="wp-block-group"
                ...
                <h2
                    ...
                    ><strong>State of Provincial Emergency</strong></h2
                >
                <!-- /wp:heading -->
            </div>
            <!-- /wp:group -->
