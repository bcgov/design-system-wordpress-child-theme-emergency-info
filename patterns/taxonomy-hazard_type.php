...
<div class="wp-block-group"
    ><!-- wp:group {"className":"alignwide","style":{"spacing":{"padding":{"top":"var:preset|spacing|30","right":"var:preset|spacing|20","bottom":"var:preset|spacing|30","left":"var:preset|spacing|20"}}},"layout":{"type":"constrained"}} -->
    <div
        ...
        <div class="wp-block-group"
            ...
            <div class="wp-block-group">
                ...
                <div
                    id="Current-Emergencies"
                    class="wp-block-group has-support-gray-01-background-color has-background"
                    ><!-- wp:group {"className":"alignwide","style":{"spacing":{"padding":{"right":"var:preset|spacing|20","left":"var:preset|spacing|20"}}},"layout":{"type":"default"}} -->
                    <div
                        class="wp-block-group alignwide"
                        ...
                        <h3
                            ...
                            style="margin-top: var(--wp--preset--spacing--20); margin-right: 0; margin-left: 0; font-size: 1.88rem"
                            >Current emergencies in B.C.</h3
                        >
                        <!-- /wp:heading -->
                        ...
                        <p
                            ...
                            >Find current emergencies by last updated date. Emergencies no longer active are not shown.</p
                        >
                        <!-- /wp:paragraph -->
                        ...
                        <div class="wp-block-query is-style-default"
                            ><!-- wp:post-template {"lock":{"move":false,"remove":false},"className":"event-query-loop","layout":{"type":"default"}} -->
                            ...
                            <div
                                class="wp-block-group hazard-border soft-shadow h-100 has-white-background-color has-background"
                                style="border-radius: 10px; border-top-width: 10px; padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0"
                                ><!-- wp:group {"className":"h-100","style":{"border":{"radius":{"bottomLeft":"10px","bottomRight":"10px"},"right":{"color":"var:preset|color|support-gray-02"},"bottom":{"color":"var:preset|color|support-gray-02"},"left":{"color":"var:preset|color|support-gray-02"}},"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}},"layout":{"type":"default"}} -->
                                <div
                                    class="wp-block-group h-100"
                                    ...
                                    ><!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|20","right":"var:preset|spacing|20","bottom":"var:preset|spacing|20","left":"var:preset|spacing|20"}}},"backgroundColor":"white","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"left"}} -->
                                    <div
                                        ...
                                        <div class="wp-block-group"
                                            ><!-- wp:group {"style":{"typography":{"fontStyle":"normal","fontWeight":"700"},"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}},"layout":{"type":"default"}} -->
                                            <div
                                                class="wp-block-group"
                                                style="margin-top: 0; margin-bottom: 0; padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0; font-style: normal; font-weight: 700"
                                                ><!-- wp:emergency-info/post-hazard-title {"className":"m-0","fontSize":"medium"} /--></div
                                            >
                                            <!-- /wp:group -->
                                    ...
                                    <div
                                        class="wp-block-group has-white-background-color has-background"
                                        style="border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; padding-top: 0; padding-right: var(--wp--preset--spacing--20); padding-bottom: 0; padding-left: var(--wp--preset--spacing--20)"
                                        ><!-- wp:group {"style":{"spacing":{"padding":{"top":"0","bottom":"0","right":"var:preset|spacing|20","left":"var:preset|spacing|20"}},"border":{"radius":"0.19rem","top":{"width":"0.3rem","color":"var:preset|color|support-gray-02"}}},"layout":{"type":"default"}} -->
                                        <div
                                            class="wp-block-group"
                                            style="border-radius: 0.19rem; border-top-color: var(--wp--preset--color--support-gray-02); border-top-width: 0.3rem; padding-top: 0; padding-right: var(--wp--preset--spacing--20); padding-bottom: 0; padding-left: var(--wp--preset--spacing--20)"
                                        ></div>
                                        <!-- /wp:group -->
                                        ...
                                        <div
                                            class="wp-block-group"
                                            style="border-radius: 0.19rem; border-top-style: none; border-top-width: 0rem; padding-top: var(--wp--preset--spacing--20); padding-right: var(--wp--preset--spacing--20); padding-bottom: var(--wp--preset--spacing--20); padding-left: var(--wp--preset--spacing--20)"
                                            ><!-- wp:emergency-info/post-emergency-alert /-->
                                            ...
                                            <div
                                                class="wp-block-group is-layout-flex flex-nowrap"
                                                style="margin-top: var(--wp--preset--spacing--20); margin-bottom: var(--wp--preset--spacing--20)"
                                                ><!-- wp:areoi/icon {"block_id":"4bc5af99-90a0-4d44-bca4-e940f72de678","style":"text-dark","icon":"bi-clock-history"} -->
                                                <div class="wp-block-areoi-icon areoi-icon"
                                                    ><i
                                                        class="text-dark bi-clock-history"
                            ...
                            <div
                                class="wp-block-group soft-shadow has-white-background-color has-background"
                                style="border-radius: 10px; padding-top: 0; padding-right: var(--wp--preset--spacing--20); padding-bottom: 0; padding-left: var(--wp--preset--spacing--20)"
                                ><!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|20","right":"0","bottom":"var:preset|spacing|20","left":"0"}}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
                                <div
                                    class="wp-block-group"
                                    style="padding-top: var(--wp--preset--spacing--20); padding-right: 0; padding-bottom: var(--wp--preset--spacing--20); padding-left: 0"
                                    ><!-- wp:image {"id":1637,"sizeSlug":"full","linkDestination":"none","className":"d-none d-sm-block","style":{"spacing":{"margin":{"right":"var:preset|spacing|20","left":"0"}}}} -->
                                    <figure
                                        class="wp-block-image size-full d-none d-sm-block"
                                        style="margin-right: var(--wp--preset--spacing--20); margin-left: 0"
                                        ><img
                                            src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/no-current-emergencies.png' ); ?>"
                                            alt=""
                                            class="wp-image-1637"
                                            title=""
                                    /></figure>
