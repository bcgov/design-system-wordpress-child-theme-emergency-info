...
<div
    ...
    <div
        ...
        <div
            ...
            ><!-- wp:areoi/icon {"block_id":"be82c5fc-09b4-4e93-9f25-994b7c8e732f","style":"text-light","icon":"bi-link","className":"hazard-background hazard-border"} -->
            <div class="wp-block-areoi-icon areoi-icon hazard-background hazard-border"
                ><i
                    class="text-light bi-link"
        ...
        <div class="wp-block-group has-small-font-size"
            ...
            <p class="has-small-font-size"
                ><strong><a href="#example">This tsunami is linked to a current earthquake (NRCan)</a></strong></p
            >
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
...
<div
    ...
    ><!-- wp:areoi/row {"block_id":"61a593c9-d361-43de-80d4-746ded96d136","className":"gy-3"} -->
    ...
    <div
        class="wp-block-group emergency-map has-typography-primary-color-background-color has-background"
        style="border-radius: 10px; padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0"
        ><!-- wp:cover {"url":"<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/bc-map-tsunami.png' ); ?>","id":1552,"dimRatio":0,"isDark":false,"className":"h-100 d-flex align-items-start","style":{"spacing":{"padding":{"top":"var:preset|spacing|40","right":"var:preset|spacing|40","bottom":"var:preset|spacing|40","left":"var:preset|spacing|40"}}}} -->
        <div
            class="wp-block-cover is-light h-100 d-flex align-items-start"
            ...
            ></span
            ><img
                class="wp-block-cover__image-background wp-image-1552"
                alt=""
                src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/bc-map-tsunami.png' ); ?>"
                data-object-fit="cover"
            />
            <div class="wp-block-cover__inner-container"
                ><!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|20","right":"var:preset|spacing|20","bottom":"var:preset|spacing|20","left":"var:preset|spacing|20"},"margin":{"bottom":"var:preset|spacing|20"}}},"backgroundColor":"white","layout":{"type":"constrained"}} -->
                <div
                    class="wp-block-group has-white-background-color has-background"
                    style="margin-bottom: var(--wp--preset--spacing--20); padding-top: var(--wp--preset--spacing--20); padding-right: var(--wp--preset--spacing--20); padding-bottom: var(--wp--preset--spacing--20); padding-left: var(--wp--preset--spacing--20)"
                    ><!-- wp:heading {"style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}},"typography":{"fontSize":"1.88rem"}}} -->
                    <h2
                        class="wp-block-heading"
                        style="padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0; font-size: 1.88rem"
                        ><strong>Tsunami Notification Zones</strong></h2
                    >
                    <!-- /wp:heading -->
                </div>
                <!-- /wp:group -->
    ...
    <div
        ...
        <div
            ...
            ><!-- wp:group {"templateLock":false,"lock":{"move":false,"remove":false},"className":"align-items-baseline","layout":{"type":"flex","flexWrap":"nowrap"}} -->
...
<div
    ...
    <div
        class="wp-block-group tsunami-zone-map has-border-color has-support-gray-02-border-color has-support-gray-01-background-color has-background"
        style="border-radius: 10px; margin-top: var(--wp--preset--spacing--20); margin-bottom: var(--wp--preset--spacing--20); padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0"
        ><!-- wp:media-text {"align":"wide","mediaId":4137,"mediaLink":"https://vanity.blog.gov.bc.ca/zone_a/","mediaType":"image","mediaWidth":25,"mediaSizeSlug":"full","imageFill":true,"focalPoint":{"x":0.63,"y":0.58},"style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}}} -->
        <div
            class="wp-block-media-text alignwide is-stacked-on-mobile is-image-fill"
            style="padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0; grid-template-columns: 25% auto"
        >
            <figure
                class="wp-block-media-text__media"
                style="background-image:url(<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/zone-a.jpg' ); ?>);background-position:63% 58%"
                ><img
                    src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/zone-a.jpg' ); ?>"
                    alt=""
                    class="wp-image-4137 size-full"
            /></figure>
            <div class="wp-block-media-text__content"
                ><!-- wp:group {"className":"h-100","layout":{"type":"default"}} -->
                <div class="wp-block-group h-100"
                    ><!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|20","right":"var:preset|spacing|20","bottom":"var:preset|spacing|20","left":"var:preset|spacing|20"}},"border":{"bottom":{"color":"var:preset|color|support-gray-02"}}},"layout":{"type":"default"}} -->
                    <div
                        class="wp-block-group"
                        style="border-bottom-color: var(--wp--preset--color--support-gray-02); padding-top: var(--wp--preset--spacing--20); padding-right: var(--wp--preset--spacing--20); padding-bottom: var(--wp--preset--spacing--20); padding-left: var(--wp--preset--spacing--20)"
                        ...
                        <div
                            ...
                            ><!-- wp:areoi/icon {"block_id":"39a66b63-5071-43b7-ab50-80429d5d6ab1","style":"text-dark","size":"36","icon":"bi-geo-alt","horizontal_align_xs":"text-center","lock":{"move":false,"remove":false},"className":"no-circle"} -->
                            <div class="wp-block-areoi-icon areoi-icon text-center no-circle"
                                ><i
                                    class="text-dark bi-geo-alt"
                    ...
                    <div
                        ...
                        style="padding-top: var(--wp--preset--spacing--20); padding-right: var(--wp--preset--spacing--20); padding-bottom: var(--wp--preset--spacing--20); padding-left: var(--wp--preset--spacing--20)"
                        ><!-- wp:areoi/row {"block_id":"512c2714-8fee-4154-9552-24a153e80132","row_cols_xs":"row-cols-1","row_cols_sm":"row-cols-sm-2"} -->
                        <!-- wp:areoi/column {"block_id":"fc9fa810-eb73-4701-a859-d2aa4ebf5e97"} -->
                        <!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|20","bottom":"var:preset|spacing|20","right":"var:preset|spacing|20"}}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
                        <div
                            class="wp-block-group"
                            style="padding-top: var(--wp--preset--spacing--20); padding-right: var(--wp--preset--spacing--20); padding-bottom: var(--wp--preset--spacing--20)"
                            ><!-- wp:areoi/icon {"block_id":"39a66b63-5071-43b7-ab50-80429d5d6ab1","style":"text-dark","icon":"bi-filetype-pdf","horizontal_align_xs":"text-center","lock":{"move":false,"remove":false}} -->
                            <div class="wp-block-areoi-icon areoi-icon text-center"
                                ><i
                        ...
                        <div
                            ...
                            style="padding-top: var(--wp--preset--spacing--20); padding-right: var(--wp--preset--spacing--20); padding-bottom: var(--wp--preset--spacing--20)"
                            ><!-- wp:paragraph -->
                            <p><strong>Expected Wave Times (Local Time)</strong></p>
                            <!-- /wp:paragraph -->
    ...
    <div
        class="wp-block-group tsunami-zone-map has-border-color has-support-gray-02-border-color has-support-gray-01-background-color has-background"
        style="border-radius: 10px; margin-top: var(--wp--preset--spacing--20); margin-bottom: var(--wp--preset--spacing--20); padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0"
        ><!-- wp:media-text {"align":"wide","mediaId":4132,"mediaLink":"https://vanity.blog.gov.bc.ca/zone-b/","mediaType":"image","mediaWidth":25,"mediaSizeSlug":"full","imageFill":true,"focalPoint":{"x":0.55,"y":0.6},"style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}}} -->
        <div
            class="wp-block-media-text alignwide is-stacked-on-mobile is-image-fill"
            style="padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0; grid-template-columns: 25% auto"
        >
            <figure
                class="wp-block-media-text__media"
                style="background-image:url(<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/zone-b.jpg' ); ?>);background-position:55% 60%"
                ><img
                    src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/zone-b.jpg' ); ?>"
                    alt=""
                    class="wp-image-4132 size-full"
            /></figure>
            <div class="wp-block-media-text__content"
                ><!-- wp:group {"className":"h-100","layout":{"type":"default"}} -->
                <div class="wp-block-group h-100"
    ...
    <div
        class="wp-block-group tsunami-zone-map has-border-color has-support-gray-02-border-color has-support-gray-01-background-color has-background"
        style="border-radius: 10px; margin-top: var(--wp--preset--spacing--20); margin-bottom: var(--wp--preset--spacing--20); padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0"
        ><!-- wp:media-text {"align":"wide","mediaId":4127,"mediaLink":"https://vanity.blog.gov.bc.ca/zone_c/","mediaType":"image","mediaWidth":25,"mediaSizeSlug":"full","imageFill":true,"focalPoint":{"x":0.58,"y":0.57},"style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}}} -->
        <div
            class="wp-block-media-text alignwide is-stacked-on-mobile is-image-fill"
            style="padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0; grid-template-columns: 25% auto"
        >
            <figure
                class="wp-block-media-text__media"
                style="background-image:url(<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/zone-c.jpg' ); ?>);background-position:58% 57%"
                ><img
                    src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/zone-c.jpg' ); ?>"
                    alt=""
                    class="wp-image-4127 size-full"
            /></figure>
            <div class="wp-block-media-text__content"
                ><!-- wp:group {"className":"h-100","layout":{"type":"default"}} -->
                <div class="wp-block-group h-100"
    ...
    <div
        class="wp-block-group tsunami-zone-map has-border-color has-support-gray-02-border-color has-support-gray-01-background-color has-background"
        style="border-radius: 10px; margin-top: var(--wp--preset--spacing--20); margin-bottom: var(--wp--preset--spacing--20); padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0"
        ><!-- wp:media-text {"align":"wide","mediaId":4122,"mediaLink":"https://vanity.blog.gov.bc.ca/zone_d/","mediaType":"image","mediaWidth":25,"mediaSizeSlug":"full","imageFill":true,"focalPoint":{"x":0.84,"y":0.77},"style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}}} -->
        <div
            class="wp-block-media-text alignwide is-stacked-on-mobile is-image-fill"
            style="padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0; grid-template-columns: 25% auto"
        >
            <figure
                class="wp-block-media-text__media"
                style="background-image:url(<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/zone-d.jpg' ); ?>);background-position:84% 77%"
                ><img
                    src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/zone-d.jpg' ); ?>"
                    alt=""
                    class="wp-image-4122 size-full"
            /></figure>
            <div class="wp-block-media-text__content"
                ><!-- wp:group {"className":"h-100","layout":{"type":"default"}} -->
                <div class="wp-block-group h-100"
    ...
    <div
        class="wp-block-group tsunami-zone-map has-border-color has-support-gray-02-border-color has-support-gray-01-background-color has-background"
        style="border-radius: 10px; margin-top: var(--wp--preset--spacing--20); margin-bottom: var(--wp--preset--spacing--20); padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0"
        ><!-- wp:media-text {"align":"wide","mediaId":4117,"mediaLink":"https://vanity.blog.gov.bc.ca/zone_e/","mediaType":"image","mediaWidth":25,"mediaSizeSlug":"full","imageFill":true,"focalPoint":{"x":0.76,"y":0.47},"style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}}} -->
        <div
            class="wp-block-media-text alignwide is-stacked-on-mobile is-image-fill"
            style="padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0; grid-template-columns: 25% auto"
        >
            <figure
                class="wp-block-media-text__media"
                style="background-image:url(<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/zone-e.jpg' ); ?>);background-position:76% 47%"
                ><img
                    src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/zone-e.jpg' ); ?>"
                    alt=""
                    class="wp-image-4117 size-full"
            /></figure>
            <div class="wp-block-media-text__content"
                ><!-- wp:group {"className":"h-100","layout":{"type":"default"}} -->
                <div class="wp-block-group h-100"
...
<div
    id="Recommended-Actions-Evaluation-Watch"
    ...
    <div
        ...
        <h2
            class="wp-block-heading"
            style="margin-bottom: var(--wp--preset--spacing--20); font-size: 1.88rem"
            >Recommended actions for a Tsunami [Evaluation/Watch]</h2
        >
        <!-- /wp:heading -->
...
<!-- wp:group {"templateLock":false,"lock":{"move":false,"remove":false},"className":"w-100 hazard-border","style":{"border":{"radius":"10px","top":{"width":"10px"}},"spacing":{"margin":{"bottom":"var:preset|spacing|30","top":"var:preset|spacing|30"},"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}},"backgroundColor":"support-gray-01","layout":{"type":"default"}} -->
<div
    id="Recommended-Actions-Advisory"
    class="wp-block-group w-100 hazard-border has-support-gray-01-background-color has-background"
    style="border-radius: 10px; border-top-width: 10px; margin-top: var(--wp--preset--spacing--30); margin-bottom: var(--wp--preset--spacing--30); padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0"
    ><!-- wp:group {"templateLock":false,"lock":{"move":false,"remove":false},"style":{"spacing":{"padding":{"top":"var:preset|spacing|20","right":"var:preset|spacing|20","bottom":"var:preset|spacing|20","left":"var:preset|spacing|20"}},"border":{"radius":{"bottomLeft":"10px","bottomRight":"10px"},"right":{"color":"var:preset|color|support-gray-02"},"bottom":{"color":"var:preset|color|support-gray-02"},"left":{"color":"var:preset|color|support-gray-02"}}},"layout":{"type":"default"}} -->
    <div
        ...
        <h2
            class="wp-block-heading"
            style="margin-bottom: var(--wp--preset--spacing--20); font-size: 1.88rem"
            >Recommended actions for a Tsunami Advisory</h2
        >
        <!-- /wp:heading -->
...
<!-- wp:group {"templateLock":false,"lock":{"move":false,"remove":false},"className":"w-100 hazard-border","style":{"border":{"radius":"10px","top":{"width":"10px"}},"spacing":{"margin":{"bottom":"var:preset|spacing|30","top":"var:preset|spacing|30"},"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}},"backgroundColor":"support-gray-01","layout":{"type":"default"}} -->
<div
    id="Recommended-Actions-Warning"
    class="wp-block-group w-100 hazard-border has-support-gray-01-background-color has-background"
    style="border-radius: 10px; border-top-width: 10px; margin-top: var(--wp--preset--spacing--30); margin-bottom: var(--wp--preset--spacing--30); padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0"
    ><!-- wp:group {"templateLock":false,"lock":{"move":false,"remove":false},"style":{"spacing":{"padding":{"top":"var:preset|spacing|20","right":"var:preset|spacing|20","bottom":"var:preset|spacing|20","left":"var:preset|spacing|20"}},"border":{"radius":{"bottomLeft":"10px","bottomRight":"10px"},"right":{"color":"var:preset|color|support-gray-02"},"bottom":{"color":"var:preset|color|support-gray-02"},"left":{"color":"var:preset|color|support-gray-02"}}},"layout":{"type":"default"}} -->
    <div
        ...
        <h2
            class="wp-block-heading"
            style="margin-bottom: var(--wp--preset--spacing--20); font-size: 1.88rem"
            >Recommended actions for a Tsunami Warning</h2
        >
        <!-- /wp:heading -->
        ...
        <div
            ...
            <div
                ...
                <div
                    ...
                    ><!-- wp:heading {"level":3,"fontSize":"small"} -->
                    <h3 class="wp-block-heading has-small-font-size"
                        ><strong><a href="https://weather.gc.ca/?layers=alert#wb-cont">Environment Canada Alerts</a></strong></h3
                    >
                    <!-- /wp:heading -->
            ...
            <div
                ...
                <div
                    ...
                    <h4 class="wp-block-heading has-small-font-size"
                        ><strong
                            ><a
                                href="https://www2.gov.bc.ca/gov/content?id=90A6A0470E464B9EB358D5B79E8EEBB3"
                                title=""
                                >PreparedBC</a
                            ></strong
                        ></h4
...
<div
    ...
    <div
        ...
        <div
            class="wp-block-group"
            style="border-left-color: #ff0000; border-left-width: 10px; margin-top: var(--wp--preset--spacing--20); margin-bottom: var(--wp--preset--spacing--20)"
            ><!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|20","right":"var:preset|spacing|20","bottom":"var:preset|spacing|20","left":"var:preset|spacing|20"}}},"backgroundColor":"white","layout":{"type":"flex","flexWrap":"nowrap","orientation":"horizontal"}} -->
            <div
                class="wp-block-group has-white-background-color has-background"
                style="padding-top: var(--wp--preset--spacing--20); padding-right: var(--wp--preset--spacing--20); padding-bottom: var(--wp--preset--spacing--20); padding-left: var(--wp--preset--spacing--20)"
                ><!-- wp:areoi/icon {"block_id":"1ef96824-6efe-4f5e-b478-5c8bcc632466","style":"text-dark","size":"60","icon":"bi-tsunami"} -->
                <div class="wp-block-areoi-icon areoi-icon"
                    ><i
                        class="text-dark bi-tsunami"
                ...
                <div
                    class="wp-block-group"
                    style="padding-top: var(--wp--preset--spacing--20); padding-left: var(--wp--preset--spacing--20)"
                    ><!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"1.38rem"}}} -->
                    <h3
                        class="wp-block-heading"
                        style="font-size: 1.38rem"
                        ><strong>Warning</strong></h3
                    >
                    <!-- /wp:heading -->
        ...
        <div
            class="wp-block-group"
            style="border-left-color: #ff8a00; border-left-width: 10px; margin-top: var(--wp--preset--spacing--20); margin-bottom: var(--wp--preset--spacing--20)"
            ><!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|20","right":"var:preset|spacing|20","bottom":"var:preset|spacing|20","left":"var:preset|spacing|20"}}},"backgroundColor":"white","layout":{"type":"flex","flexWrap":"nowrap","orientation":"horizontal"}} -->
            <div
                class="wp-block-group has-white-background-color has-background"
                style="padding-top: var(--wp--preset--spacing--20); padding-right: var(--wp--preset--spacing--20); padding-bottom: var(--wp--preset--spacing--20); padding-left: var(--wp--preset--spacing--20)"
        ...
        <div
            class="wp-block-group"
            style="border-left-color: #ffe600; border-left-width: 10px; margin-top: var(--wp--preset--spacing--20); margin-bottom: var(--wp--preset--spacing--20)"
            ><!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|20","right":"var:preset|spacing|20","bottom":"var:preset|spacing|20","left":"var:preset|spacing|20"}}},"backgroundColor":"white","layout":{"type":"flex","flexWrap":"nowrap","orientation":"horizontal"}} -->
            <div
                class="wp-block-group has-white-background-color has-background"
                style="padding-top: var(--wp--preset--spacing--20); padding-right: var(--wp--preset--spacing--20); padding-bottom: var(--wp--preset--spacing--20); padding-left: var(--wp--preset--spacing--20)"
        ...
        <div
            class="wp-block-group"
            style="border-left-color: #053ead; border-left-width: 10px; margin-top: var(--wp--preset--spacing--20); margin-bottom: var(--wp--preset--spacing--20)"
            ><!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|20","right":"var:preset|spacing|20","bottom":"var:preset|spacing|20","left":"var:preset|spacing|20"}}},"backgroundColor":"white","layout":{"type":"flex","flexWrap":"nowrap","orientation":"horizontal"}} -->
            <div
                class="wp-block-group has-white-background-color has-background"
                style="padding-top: var(--wp--preset--spacing--20); padding-right: var(--wp--preset--spacing--20); padding-bottom: var(--wp--preset--spacing--20); padding-left: var(--wp--preset--spacing--20)"
                ><!-- wp:areoi/icon {"block_id":"1ef96824-6efe-4f5e-b478-5c8bcc632466","style":"text-dark","size":"60","icon":"bi-info-lg"} -->
                <div class="wp-block-areoi-icon areoi-icon"
                    ><i
                        class="text-dark bi-info-lg"
                        style="font-size: 60px"
                    ></i
                ></div>
                <!-- /wp:areoi/icon -->
                ...
                <div
                    ...
                    <h3
                        class="wp-block-heading"
                        style="font-size: 1.38rem"
                        ><strong>Information Statement</strong></h3
                    >
                    <!-- /wp:heading -->
        ...
        <div
            class="wp-block-group"
            style="border-left-color: #59595c; border-left-width: 10px; margin-top: var(--wp--preset--spacing--20); margin-bottom: var(--wp--preset--spacing--20)"
            ><!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|20","right":"var:preset|spacing|20","bottom":"var:preset|spacing|20","left":"var:preset|spacing|20"}}},"backgroundColor":"white","layout":{"type":"flex","flexWrap":"nowrap","orientation":"horizontal"}} -->
            <div
                class="wp-block-group has-white-background-color has-background"
                style="padding-top: var(--wp--preset--spacing--20); padding-right: var(--wp--preset--spacing--20); padding-bottom: var(--wp--preset--spacing--20); padding-left: var(--wp--preset--spacing--20)"
                ><!-- wp:areoi/icon {"block_id":"1ef96824-6efe-4f5e-b478-5c8bcc632466","style":"text-dark","size":"60","icon":"bi-dash"} -->
                <div class="wp-block-areoi-icon areoi-icon"
                    ><i
                        class="text-dark bi-dash"
                        style="font-size: 60px"
                    ></i
                ></div>
                <!-- /wp:areoi/icon -->
...
<div
    ...
    <div
        ...
        <h2
            class="wp-block-heading"
            style="margin-bottom: var(--wp--preset--spacing--20); font-size: 1.88rem"
            >Know your Tsunami Notification Zones</h2
        >
        <!-- /wp:heading -->
        ...
        <figure class="wp-block-image size-full"
            ><img
                src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/tsunami-zones.jpg' ); ?>"
                alt="Map of the tsunami notification zones"
                class="wp-image-4142"
                title=""
        /></figure>
        <!-- /wp:image -->
    ...
    <div
        ...
        <div
            ...
            <div
                class="wp-block-group hazard-background-secondary h-100 d-flex align-items-center"
                style="padding-top: var(--wp--preset--spacing--20)"
                ><!-- wp:image {"id":37907,"sizeSlug":"full","linkDestination":"none"} -->
                <figure class="wp-block-image size-full"
                    ><img
                        src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/travel-information.png' ); ?>"
                        alt=""
                        class="wp-image-37907"
                        title=""
                /></figure>
                <!-- /wp:image -->
            </div>
            ...
            <div
                class="wp-block-group align-items-start"
                style="padding-top: var(--wp--preset--spacing--20); padding-right: var(--wp--preset--spacing--20); padding-bottom: var(--wp--preset--spacing--20); padding-left: var(--wp--preset--spacing--20)"
                ><!-- wp:areoi/icon {"block_id":"39a66b63-5071-43b7-ab50-80429d5d6ab1","style":"text-dark","size":"36","icon":"bi-link","horizontal_align_xs":"text-center","lock":{"move":true,"remove":true}} -->
                <div class="wp-block-areoi-icon areoi-icon text-center"
                    ><i
                        class="text-dark bi-link"
                        style="font-size: 36px"
    ...
    <div
        ...
        <div
            ...
            <div
                class="wp-block-group hazard-background-secondary h-100 d-flex align-items-center"
                style="padding-top: var(--wp--preset--spacing--20)"
                ><!-- wp:image {"id":37912,"sizeSlug":"full","linkDestination":"none"} -->
                <figure class="wp-block-image size-full"
                    ><img
                        src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/essential-assistance.png' ); ?>"
                        alt=""
                        class="wp-image-37912"
                        title=""
                /></figure>
                <!-- /wp:image -->
            </div>
