...
<div
    ...
    <div
        ...
        <div
            ...
            ><!-- wp:areoi/icon {"block_id":"be82c5fc-09b4-4e93-9f25-994b7c8e732f","style":"text-light","icon":"bi-link"} -->
            ...
            <p class="has-small-font-size"
                ><strong><a href="https://tsunami.gov/">National Tsunami Warning Center (NTWC)</a></strong></p
            >
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
        ...
        <div class="wp-block-group has-small-font-size"
            ...
            <!-- wp:paragraph {"fontSize":"small"} -->
            <p class="has-small-font-size"
                ><strong><a href="#example">This tsunami is linked to a current earthquake</a></strong></p
            >
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
...
<div
    ...
    <!-- wp:group {"style":{"border":{"radius":"10px"},"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}},"backgroundColor":"typography-color-primary","className":"emergency-map","layout":{"type":"default"}} -->
    <div
        class="wp-block-group emergency-map has-typography-color-primary-background-color has-background"
        style="border-radius: 10px; padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0"
        ><!-- wp:cover {"url":"<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/bc-map-tsunami.png' ); ?>","id":1552,"dimRatio":0,"isDark":false,"style":{"spacing":{"padding":{"top":"var:preset|spacing|40","right":"var:preset|spacing|40","bottom":"var:preset|spacing|40","left":"var:preset|spacing|40"}}},"className":"h-100 d-flex align-items-start"} -->
        <div
...
<div
    ...
    <div
        ...
        <div
            ...
            <!-- wp:areoi/column {"block_id":"efedf348-a0ff-4ff0-b8d1-78c2bb2bf89a","lock":{"move":false,"remove":false},"className":"px-0"} -->
            <!-- wp:group {"className":"emergency-map","style":{"border":{"radius":"10px"},"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}},"backgroundColor":"typography-color-primary","layout":{"type":"default"}} -->
            <div
                class="wp-block-group emergency-map has-typography-color-primary-background-color has-background"
                style="border-radius: 10px; padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0"
...
<div
    ...
    <div
        ...
        <figure class="wp-block-image size-full"
            ><a href="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/tsunami-zones.jpg' ); ?>"
                ><img
