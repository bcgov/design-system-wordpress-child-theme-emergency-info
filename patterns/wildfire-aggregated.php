...
<div
    ...
    <div
        ...
        <div
            ...
            ><!-- wp:group {"style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}},"className":"hazard-border","layout":{"type":"default"}} -->
            <div
                class="wp-block-group hazard-border"
                style="padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0"
                ><!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|20","right":"var:preset|spacing|20","bottom":"var:preset|spacing|20","left":"var:preset|spacing|20"}},"border":{"radius":{"topLeft":"10px","topRight":"10px"},"color":"#DBDFF0"}},"backgroundColor":"support-gray-01","className":"hazard-border","layout":{"type":"flex","flexWrap":"nowrap"}} -->
                <div
            ...
            <div
                ...
                <div
                    class="wp-block-group"
                    style="padding-bottom: var(--wp--preset--spacing--20)"
                    ><!-- wp:areoi/icon {"block_id":"4bc5af99-90a0-4d44-bca4-e940f72de678","style":"text-dark","icon":"bi-filetype-pdf"} -->
                    <div class="wp-block-areoi-icon areoi-icon"
                        ><i
    ...
    <div
        ...
        <div
            ...
            <h2
                ...
                >Recommended actions for Evacuation Orders</h2
            >
            <!-- /wp:heading -->
...
<div
    ...
    <div
        ...
        <div
            ...
            ><!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap"}} -->
            <div class="wp-block-group"
                ><!-- wp:image {"id":61507,"width":"75px","sizeSlug":"full","linkDestination":"none"} -->
                <figure class="wp-block-image size-full is-resized"
                    ><img
    ...
    <div
        ...
        <div
            ...
            <h2
                class="wp-block-heading"
                style="margin-bottom: var(--wp--preset--spacing--20); font-size: 1.88rem"
                >Recommended actions for Evacuation Alerts</h2
            >
            <!-- /wp:heading -->
...
<div
    ...
    <div
        ...
        <div
            class="wp-block-group aggregated-card d-flex flex-column h-100"
            style="padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0"
            ><!-- wp:group {"style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}},"border":{"top":{"width":"10px"},"radius":{"topLeft":"10px","topRight":"10px"}}},"className":"hazard-border","layout":{"type":"default"}} -->
            <div
                class="wp-block-group hazard-border"
                style="border-top-left-radius: 10px; border-top-right-radius: 10px; border-top-width: 10px; padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0"
                ...
                <div
                    ...
                    style="border-bottom-left-radius: 0px; border-bottom-right-radius: 0px; border-top-style: none; border-top-width: 0px; border-right-color: var(--wp--preset--color--support-gray-02); border-bottom-color: var(--wp--preset--color--support-gray-02); border-left-color: var(--wp--preset--color--support-gray-02); padding-top: var(--wp--preset--spacing--20); padding-right: var(--wp--preset--spacing--20); padding-bottom: var(--wp--preset--spacing--20); padding-left: var(--wp--preset--spacing--20)"
                    ><!-- wp:group {"layout":{"type":"flex","orientation":"vertical"}} -->
                    <div class="wp-block-group"
                        ><!-- wp:paragraph -->
                        <p><strong>Evacuation Order</strong></p>
        ...
        <h2
            class="wp-block-heading"
            style="margin-bottom: var(--wp--preset--spacing--20); font-size: 1.88rem"
            ><strong>Recommended actions for Evacuation Orders</strong></h2
        >
        <!-- /wp:heading -->
...
<div
    ...
    <div
        ...
        <h2
            class="wp-block-heading"
            style="margin-bottom: var(--wp--preset--spacing--20); font-size: 1.88rem"
            ><strong>Recommended actions for Evacuation Alerts</strong></h2
        >
        <!-- /wp:heading -->
