    ...
    >
        ...
        >
            ...
            <h2
                ...
                ><strong>BC Wildfire Service information</strong></h2
            >
            <!-- /wp:heading -->
        </div>
        <!-- /wp:group -->
            ...
            >
                ...
                >
                    ...
                    <div class="wp-block-group">
                        ...
                        <p
                            ><a
                                href="https://wildfiresituation.nrs.gov.bc.ca/list"
                                title=""
                                >BC Wildfire Service List
                            </a>
                        </p>
                        <!-- /wp:paragraph -->
                    </div>
                ...
                >
                    ...
                    <h3 class="wp-block-heading has-small-font-size"
                        ><a
                            ...
                            title=""
                            ><strong>Mental</strong> <strong>health supports</strong></a
                        ></h3
                    >
                    <!-- /wp:heading -->
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <div
                        class="wp-block-group h-100 has-background-white-background-color has-background"
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <!-- wp:heading {"level":4,"fontSize":"small"} -->
                                <h4 class="wp-block-heading has-small-font-size"><strong>Tactical Evacuation</strong> </h4>
                                <!-- /wp:heading -->

                                <!-- wp:paragraph -->
                                <p>A sudden threat to life requires immediate action. There is no time to prepare or issue written warnings. Local emergency responders coordinate the evacuation. Follow the advice and direction of authorities.</p>
                                <!-- /wp:paragraph -->
                            </div>
                            <!-- /wp:group -->
                        </div>
