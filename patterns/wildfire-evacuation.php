...
<div id="Map-Information" class="wp-block-group"
    ...
    <div class="wp-block-group has-border-color has-support-gray-02-border-color"
    ...
    <div class="wp-block-group"
        style="margin-top:var(--wp--preset--spacing--30);margin-bottom:var(--wp--preset--spacing--30);padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
        ...
        <div class="wp-block-group has-border-color has-support-gray-02-border-color has-support-gray-01-background-color has-background"
        ...
        <div class="wp-block-group has-white-background-color has-background"
            ...
            <div class="wp-block-group justify-content-between"
                ...
                <div class="wp-block-group">
                    ...
                    <div class="wp-block-areoi-icon areoi-icon"><i class="text-dark bi-facebook "
                            style="font-size:24px"></i></div>
                    <!-- /wp:areoi/icon -->
            ...
            <div class="wp-block-group"
                ...
                <div class="wp-block-group">
                    ...
                    <div class="wp-block-areoi-icon areoi-icon"><i class="text-dark bi-twitter-x "
                            style="font-size:24px"></i></div>
                    <!-- /wp:areoi/icon -->
    ...
    <div class="wp-block-group"
        ...
        <div class="wp-block-group has-border-color has-support-gray-02-border-color has-support-gray-01-background-color has-background"
            ...
            <div class="wp-block-group">
                ...
                <div class="wp-block-areoi-icon areoi-icon text-center"><i class="text-dark bi-exclamation-circle "
                        style="font-size:24px"></i></div>
                <!-- /wp:areoi/icon -->
        ...
        <div class="wp-block-group has-white-background-color has-background"
            ...
            <div class="wp-block-group align-items-start"
                ...
                <div class="wp-block-group" style="padding-left:var(--wp--preset--spacing--20)">
                    ...
                    <div class="wp-block-areoi-icon areoi-icon  d-inline-block"><i class="text-dark bi-link "
                            style="font-size:24px"></i></div>
                    <!-- /wp:areoi/icon -->
    ...
    <div class="wp-block-group"
        ...
        <div class="wp-block-group has-white-background-color has-background"
            ...
            <div class="wp-block-group align-items-start"
                ...
                <div class="wp-block-areoi-icon areoi-icon text-center"><i class="text-dark bi-buildings "
            ...
            <div class="wp-block-group align-items-start"
                ...
                <div class="wp-block-group" style="padding-left:var(--wp--preset--spacing--20)">
                    ...
                    <h3 class="wp-block-heading has-small-font-size"><strong><a
                                href="https://www2.gov.bc.ca/gov/content?id=F4EA16310CC541899EFC156A60D74FC9"
                                title="">BC Wildfire Service</a></strong></h3>
                    <!-- /wp:heading -->
            ...
            <div class="wp-block-group align-items-start"
                ...
                <div class="wp-block-group" style="padding-left:var(--wp--preset--spacing--20)">
                    ...
                    <h2 class="wp-block-heading has-small-font-size"><strong><a
                                href="https://www.drivebc.ca/">DriveBC</a></strong></h2>
                    <!-- /wp:heading -->
            ...
            <div class="wp-block-group align-items-start"
                ...
                <div class="wp-block-group" style="padding-left:var(--wp--preset--spacing--20)">
                    ...
                    <h3 class="wp-block-heading has-small-font-size"><a
                            href="https://www2.gov.bc.ca/gov/content/health/managing-your-health/mental-health-substance-use/virtual-mental-health-supports"
                            title=""><strong>Mental</strong> <strong>health supports</strong></a></h3>
                    <!-- /wp:heading -->
            ...
            <div class="wp-block-group align-items-start"
                ...
                <div class="wp-block-group" style="padding-left:var(--wp--preset--spacing--20)">
                    ...
                    <h3 class="wp-block-heading has-small-font-size"><strong><a
                                ...
                                title="">Wildfire evacuee guidance</a></strong></h3>
                    <!-- /wp:heading -->
            ...
            <div class="wp-block-group align-items-start"
                ...
                <div class="wp-block-group" style="padding-left:var(--wp--preset--spacing--20)">
                    <!-- wp:heading {"level":3,"fontSize":"small"} -->
                    <h3 class="wp-block-heading has-small-font-size"><strong><a
                                href="https://www2.gov.bc.ca/gov/content?id=AD63768577B74F0D865B249B9CFC1A49"
                                title="">PreparedBC</a></strong></h3>
                    <!-- /wp:heading -->
...
<div id="Definitions" class="wp-block-group w-100 hazard-border has-support-gray-01-background-color has-background"
    ...
    <div class="wp-block-group"
        ...
        <div id="Evacuation-Stages" class="wp-block-group"
            style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
            ...
            <div class="wp-block-group" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
                ...
                <div class="wp-block-group" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
                    ...
                    <div class="wp-block-group h-100 has-background-white-background-color has-background"
                        style="border-radius:10px;border-top-color:#9393A9;border-top-width:10px;border-right-color:#DBDFF0;border-right-width:1px;border-bottom-color:#DBDFF0;border-bottom-width:1px;border-left-color:#DBDFF0;border-left-width:1px;padding-top:var(--wp--preset--spacing--20);padding-right:0;padding-bottom:var(--wp--preset--spacing--20);padding-left:0">
                        <!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|20","right":"0","bottom":"var:preset|spacing|20","left":"0"}}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"center"}} -->
                        <div class="wp-block-group"
                            style="padding-top:var(--wp--preset--spacing--20);padding-right:0;padding-bottom:var(--wp--preset--spacing--20);padding-left:0">
                            <!-- wp:image {"id":36052,"sizeSlug":"full","linkDestination":"none"} -->
