...
<div
    ...
    <div
        ...
        ><!-- wp:group {"className":"justify-content-between","style":{"spacing":{"padding":{"top":"var:preset|spacing|20","right":"var:preset|spacing|20","bottom":"var:preset|spacing|20","left":"var:preset|spacing|20"}}},"layout":{"type":"flex","flexWrap":"wrap"}} -->
        <div
...
<div
    ...
    <div
        class="wp-block-group w-100 has-transparent-background-color has-background"
        style="border-radius: 10px; border-top-color: var(--wp--preset--color--support-red); border-top-width: 18px; margin-top: var(--wp--preset--spacing--30); margin-bottom: var(--wp--preset--spacing--30); padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0"
        ><!-- wp:group {"className":"aggregated-section-header","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|20"},"padding":{"top":"var:preset|spacing|20","bottom":"var:preset|spacing|20","left":"var:preset|spacing|20","right":"var:preset|spacing|20"}},"color":{"gradient":"linear-gradient(0deg,rgba(7,146,227,0) 0%,rgb(239,242,255) 100%)"}},"layout":{"type":"constrained","justifyContent":"left"}} -->
        <div
            class="wp-block-group aggregated-section-header has-background"
            style="background: linear-gradient(0deg, rgba(7, 146, 227, 0) 0%, rgb(239, 242, 255) 100%); margin-bottom: var(--wp--preset--spacing--20); padding-top: var(--wp--preset--spacing--20); padding-right: var(--wp--preset--spacing--20); padding-bottom: var(--wp--preset--spacing--20); padding-left: var(--wp--preset--spacing--20)"
            ><!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap"}} -->
            <div class="wp-block-group"
                ><!-- wp:image {"id":61502,"width":"75px","sizeSlug":"full","linkDestination":"none"} -->
                <figure class="wp-block-image size-full is-resized"
                    ><img
                        src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/evacuation-move.png' ); ?>"
                        alt=""
                        class="wp-image-61502"
                        style="width: 75px"
                        title=""
                /></figure>
                <!-- /wp:image -->
                ...
                <div class="wp-block-group"
                    ...
                    <h2
                        ...
                        ><strong>Evacuation Orders</strong></h2
                    >
                    <!-- /wp:heading -->
        ...
        <div
            class="wp-block-group d-flex flex-column h-100"
            style="padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0"
            ><!-- wp:group {"className":"hazard-border","style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}},"layout":{"type":"default"}} -->
            <div
                class="wp-block-group hazard-border"
                style="padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0"
                ><!-- wp:group {"className":"hazard-border","style":{"spacing":{"padding":{"top":"var:preset|spacing|20","right":"var:preset|spacing|20","bottom":"var:preset|spacing|20","left":"var:preset|spacing|20"}},"border":{"radius":{"topLeft":"10px","topRight":"10px"},"color":"#DBDFF0"}},"backgroundColor":"support-gray-01","layout":{"type":"flex","flexWrap":"nowrap"}} -->
                <div
                    class="wp-block-group hazard-border has-border-color has-support-gray-01-background-color has-background"
                    style="border-color: #dbdff0; border-top-left-radius: 10px; border-top-right-radius: 10px; padding-top: var(--wp--preset--spacing--20); padding-right: var(--wp--preset--spacing--20); padding-bottom: var(--wp--preset--spacing--20); padding-left: var(--wp--preset--spacing--20)"
                    ><!-- wp:group {"layout":{"type":"flex","orientation":"vertical"}} -->
                    <div class="wp-block-group"
                        ><!-- wp:paragraph -->
            ...
            <div
                class="wp-block-group flex-fill has-white-background-color has-background"
                style="border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; border-right-color: var(--wp--preset--color--support-gray-02); border-bottom-color: var(--wp--preset--color--support-gray-02); border-left-color: var(--wp--preset--color--support-gray-02); padding-top: var(--wp--preset--spacing--20); padding-right: var(--wp--preset--spacing--20); padding-bottom: 0; padding-left: var(--wp--preset--spacing--20)"
                ...
                <div
                    ...
                    ><!-- wp:areoi/icon {"block_id":"4bc5af99-90a0-4d44-bca4-e940f72de678","style":"text-dark","icon":"bi-geo-alt"} -->
                    <div class="wp-block-areoi-icon areoi-icon"
                        ><i
                ...
                <div
                    class="wp-block-group"
                    style="padding-bottom: var(--wp--preset--spacing--20)"
                    ><!-- wp:areoi/icon {"block_id":"4bc5af99-90a0-4d44-bca4-e940f72de678","style":"text-dark","icon":"bi-calendar-check"} -->
                    <div class="wp-block-areoi-icon areoi-icon"
                        ><i
                            class="text-dark bi-calendar-check"
                            style="font-size: 24px"
                        ></i
                    ></div>
                    <!-- /wp:areoi/icon -->
                ...
                <div
                    class="wp-block-group"
                    style="padding-bottom: var(--wp--preset--spacing--20)"
                    ><!-- wp:areoi/icon {"block_id":"4bc5af99-90a0-4d44-bca4-e940f72de678","style":"text-dark","icon":"bi-link"} -->
                    <div class="wp-block-areoi-icon areoi-icon"
                        ><i
                            class="text-dark bi-link"
                            style="font-size: 24px"
    ...
    <div
        ...
        class="wp-block-group w-100 has-support-gray-01-background-color has-background"
        style="border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; border-bottom-color: var(--wp--preset--color--support-red); border-bottom-width: 12px; margin-top: var(--wp--preset--spacing--30); margin-bottom: var(--wp--preset--spacing--30); padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0"
        ...
        <div
            class="wp-block-group"
            style="border-top-left-radius: 10px; border-top-right-radius: 10px; border-top-color: #dbdff0; border-right-color: #dbdff0; border-left-color: #dbdff0; padding-top: var(--wp--preset--spacing--20); padding-right: var(--wp--preset--spacing--20); padding-bottom: var(--wp--preset--spacing--20); padding-left: var(--wp--preset--spacing--20)"
            ...
            <h2
                ...
                >Recommended actions for an Evacuation Order</h2
            >
            <!-- /wp:heading -->
            ...
            <div
                ...
                <div
                    class="wp-block-group h-100 d-flex align-items-center has-support-red-background-color has-background"
                ...
                <div
                    ...
                    <h3 class="wp-block-heading has-small-font-size"
                        ><strong>Follow all directions from <a href="https://www.civicinfo.bc.ca/directories">your local authority or First Nation</a>:</strong></h3
                    >
                    <!-- /wp:heading -->
                </div>
                <!-- /wp:group -->
                ...
                <div
                    ...
                    <div
                        ...
                        <!-- wp:paragraph {"className":"d-inline"} -->
                        <p class="d-inline"
                            >ESS Reception Centres may also be posted by your community on
                            <a
                                href="http://www.EmergencyMapBC.ca"
                                title=""
                                >EmergencyMapBC</a
                            ></p
                        >
                ...
                <div
                    ...
                    <div
                        ...
                        <p class="d-inline"
                            ><a
                                data-type="link"
                                data-id="https://ess.gov.bc.ca/"
                                href="https://ess.gov.bc.ca/"
                                >Emergency Support Services (ESS)</a
                            >
                            and learn how to access short-term basic support</p
                        >
                        <!-- /wp:paragraph -->
                        ...
                        <div class="wp-block-group"
                            ...
                            <p
                                >Call
                                <a
                                    href="tel:1-800-387-4258"
                                    title=""
                                    >1-800-387-4258</a
                                >
                                for help with online registration or general information</p
                            >
                            <!-- /wp:paragraph -->
                        </div>
                        <!-- /wp:group -->
...
<div
    ...
    <div
        class="wp-block-group w-100 has-transparent-background-color has-background"
        style="border-radius: 10px; border-top-color: var(--wp--preset--color--support-yellow); border-top-width: 18px; margin-top: var(--wp--preset--spacing--30); margin-bottom: var(--wp--preset--spacing--30); padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0"
        ><!-- wp:group {"className":"aggregated-section-header","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|20"},"padding":{"top":"var:preset|spacing|20","bottom":"var:preset|spacing|20","left":"var:preset|spacing|20","right":"var:preset|spacing|20"}},"color":{"gradient":"linear-gradient(0deg,rgba(7,146,227,0) 0%,rgb(239,242,255) 100%)"}},"layout":{"type":"constrained","justifyContent":"left"}} -->
        <div
            class="wp-block-group aggregated-section-header has-background"
            style="background: linear-gradient(0deg, rgba(7, 146, 227, 0) 0%, rgb(239, 242, 255) 100%); margin-bottom: var(--wp--preset--spacing--20); padding-top: var(--wp--preset--spacing--20); padding-right: var(--wp--preset--spacing--20); padding-bottom: var(--wp--preset--spacing--20); padding-left: var(--wp--preset--spacing--20)"
            ><!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap"}} -->
            <div class="wp-block-group"
                ><!-- wp:image {"id":61507,"width":"75px","height":"75px","scale":"contain","sizeSlug":"full","linkDestination":"none","style":{"layout":{"selfStretch":"fixed","flexSize":"75px"}}} -->
                <figure class="wp-block-image size-full is-resized"
                    ><img
                        src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/evacuation-wait.png' ); ?>"
                        alt=""
                        class="wp-image-61507"
                        style="object-fit: contain; width: 75px; height: 75px"
                        title=""
                /></figure>
                <!-- /wp:image -->
                ...
                <h2
                    class="wp-block-heading"
                    style="font-size: 1.88rem"
                    ><strong>Evacuation Alerts</strong></h2
                >
                <!-- /wp:heading -->
            </div>
            <!-- /wp:group -->
    ...
    <div
        id="Recommended-Actions"
        class="wp-block-group w-100 has-support-gray-01-background-color has-background"
        style="border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; border-bottom-color: var(--wp--preset--color--support-yellow); border-bottom-width: 12px; margin-top: var(--wp--preset--spacing--30); margin-bottom: var(--wp--preset--spacing--30); padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0"
        ><!-- wp:group {"templateLock":false,"lock":{"move":false,"remove":false},"style":{"spacing":{"padding":{"top":"var:preset|spacing|20","right":"var:preset|spacing|20","bottom":"var:preset|spacing|20","left":"var:preset|spacing|20"}},"border":{"radius":{"topLeft":"10px","topRight":"10px"},"top":{"color":"#DBDFF0"},"right":{"color":"#DBDFF0"},"bottom":[],"left":{"color":"#DBDFF0"}}},"layout":{"type":"default"}} -->
        <div
            class="wp-block-group"
            style="border-top-left-radius: 10px; border-top-right-radius: 10px; border-top-color: #dbdff0; border-right-color: #dbdff0; border-left-color: #dbdff0; padding-top: var(--wp--preset--spacing--20); padding-right: var(--wp--preset--spacing--20); padding-bottom: var(--wp--preset--spacing--20); padding-left: var(--wp--preset--spacing--20)"
            ...
            <h2
                class="wp-block-heading"
                style="margin-bottom: var(--wp--preset--spacing--20); font-size: 1.88rem"
                >Recommended actions for an Evacuation Alert</h2
            >
            <!-- /wp:heading -->
            ...
            <div
                ...
                <div
                    class="wp-block-group h-100 d-flex align-items-center has-support-yellow-background-color has-background"
                    style="padding-top: var(--wp--preset--spacing--20)"
                    ><!-- wp:image {"id":3365,"sizeSlug":"full","linkDestination":"none"} -->
                    <figure class="wp-block-image size-full"
                        ><img
        ...
        <div
            ...
            <div
                ...
                <div
                    ...
                    ><!-- wp:heading {"level":3,"fontSize":"small"} -->
                    <h3 class="wp-block-heading has-small-font-size"
                        ><strong><a href="https://www2.gov.bc.ca/gov/content/safety/wildfire-status">BC Wildfire Service</a></strong></h3
                    >
                    <!-- /wp:heading -->
            ...
            <div
                ...
                <div
                    ...
                    <h3 class="wp-block-heading has-small-font-size"
                        ><strong
                            ><a
                                href="https://www2.gov.bc.ca/gov/content/safety/emergency-management/preparedbc/evacuation-recovery/evacuee-guidance#wildfire"
                                title=""
                                >Wildfire evacuee guidance</a
                            ></strong
                        ></h3
                    >
                    <!-- /wp:heading -->
            ...
            <div
                ...
                <div
                    ...
                    <h3 class="wp-block-heading has-small-font-size"
                        ><strong
                            ><a
                                href="https://www2.gov.bc.ca/gov/content/safety/emergency-management/preparedbc/know-your-hazards/wildfires"
                                title=""
                                >PreparedBC</a
                            ></strong
                        ></h3
